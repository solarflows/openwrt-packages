...
*   **筛选后的 IPv4 列表**：内置列表基于 [Cloudflare 公开的 IPv4 地址段](https://www.cloudflare.com/ips-v4)，并根据连通性验证主动排除受限或不适用的网段：`108.162.192.0/18`、`162.158.0.0/16`、`162.159.0.0/18`、`172.64.228.0/24`、`172.68.0.0/14`、`198.41.192.0/19`。
